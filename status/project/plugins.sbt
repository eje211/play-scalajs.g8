...
// We need to use ScalaJS 0.6 because the LeafletJS façade has only been made for 0.6 and I
// really don't feel like redoing it from scratch or even recompiling it.
